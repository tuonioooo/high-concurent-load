...
| URI 请求 | HTTP 响应 |
| :--- | :--- |
| curl [http://localhost:9090/](http://localhost:9090/) | 403 Forbidden |
| curl [http://localhost:9090/index.html](http://localhost:9090/index.html) | Welcome to nginx! |
| curl [http://localhost:9090/index\_notfound.html](http://localhost:9090/index_notfound.html) | 404 Not Found |
| curl [http://localhost:9090/index.txt](http://localhost:9090/index.txt) | 403 Forbidden |

**测试结果详解：**

> curl [http://localhost:9090/](http://localhost:9090/) 的结果是“ 403 Forbidden ”，说明被匹配到“ location / {..deny all;} ”了，原因很简单HTTP 请求 GET / 被“严格精确”匹配到了普通 location / {} ，则会停止搜索正则 location ；
>
...
| URI 请求 | 修改前 | 修改后 |
| :--- | :--- | :--- |
| curl [http://localhost:9090/](http://localhost:9090/) | 403 Forbidden | 403 Forbidden |
| curl [http://localhost:9090/index.html](http://localhost:9090/index.html) | Welcome to nginx! | 403 Forbidden |
| curl [http://localhost:9090/index\_notfound.html](http://localhost:9090/index_notfound.html) | 404 Not Found | 403 Forbidden |
| curl [http://localhost:9090/exact/match.html](http://localhost:9090/exact/match.html) | 404 Not Found | 404 Not Found |
...
| :--- | :--- | :--- |
| curl [http://localhost:9090/](http://localhost:9090/) | 403 Forbidden | 403 Forbidden |
| curl [http://localhost:9090/index.html](http://localhost:9090/index.html) | Welcome to nginx! | Welcome to nginx! |
| curl [http://localhost:9090/index\_notfound.html](http://localhost:9090/index_notfound.html) | 404 Not Found | 404 Not Found |
| curl [http://localhost:9090/exact/match.html](http://localhost:9090/exact/match.html) | 404 Not Found | 404 Not Found |
| curl [http://localhost:9090/test.jsp](http://localhost:9090/test.jsp) | 403 Forbidden | 404 Not Found |
...
| :--- | :--- | :--- |
| curl [http://localhost:9090/regextest.html](http://localhost:9090/regextest.html) | 404 Not Found | 404 Not Found |
| curl [http://localhost:9090/prefix/regextest.html](http://localhost:9090/prefix/regextest.html) | 404 Not Found | 403 Forbidden |
...
| URI 请求 | 配置 3.1 | 配置 3.2 |
| :--- | :--- | :--- |
| curl [http://localhost:9090/prefix/t.html](http://localhost:9090/prefix/t.html) | 403 Forbidden | 403 Forbidden |
| curl [http://localhost:9090/prefix/mid/t.html](http://localhost:9090/prefix/mid/t.html) | 404 Not Found | 404 Not Found |
...
>
> [http://www.baidu.com](http://www.baidu.com/)，于是 nginx 给 [http://www.baidu.com](http://www.baidu.com) 发送了 GET /nofound.html ，但/nofound.html 页面在百度也不存在，百度 302 跳转到错误页。

直接访问 [http://www.baidu.com/nofound.html](http://www.baidu.com/nofound.html)
...
当 curl [http://localhost:9090/duty/](http://localhost:9090/duty/) -i 时， nginx 没找到对应的页面，于是 error\_page = @fallback ，把请求代理到 baidu.com 。注意这里的 error\_page = @fallback 不是靠重定向实现的，而是所说的“ internally redirected （forward ）”。
